#define NUM_LEDS 30 // число светодиодов в ленте с эффектами
...
//--------------------------------ЗОНЫ-----------------------------------//
uint8_t zone1[] = {0,1,2,27,28,29}; //разбивка светодиодов в ленте с эффектами на зоны, не повторять и не забывать светодиоды
